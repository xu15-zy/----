 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(N,Y){var j=N.length;N.push(Y);e:for(;0<j;){var te=j-1>>>1,ae=N[te];if(0<r(ae,Y))N[te]=Y,N[j]=ae,j=te;else break e}}function n(N){return N.length===0?null:N[0]}function i(N){if(N.length===0)return null;var Y=N[0],j=N.pop();if(j!==Y){N[0]=j;e:for(var te=0,ae=N.length,Be=ae>>>1;te<Be;){var Je=2*(te+1)-1,Ve=N[Je],Z=Je+1,se=N[Z];if(0>r(Ve,j))Z<ae&&0>r(se,Ve)?(N[te]=se,N[Z]=j,te=Z):(N[te]=Ve,N[Je]=j,te=Je);else if(Z<ae&&0>r(se,j))N[te]=se,N[Z]=j,te=Z;else break e}}return Y}function r(N,Y){var j=N.sortIndex-Y.sortIndex;return j!==0?j:N.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var a=Date,o=a.now();t.unstable_now=function(){return a.now()-o}}var l=[],u=[],d=1,h=null,c=3,p=!1,g=!1,x=!1,m=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function M(N){for(var Y=n(u);Y!==null;){if(Y.callback===null)i(u);else if(Y.startTime<=N)i(u),Y.sortIndex=Y.expirationTime,e(l,Y);else break;Y=n(u)}}function y(N){if(x=!1,M(N),!g)if(n(l)!==null)g=!0,K(w);else{var Y=n(u);Y!==null&&k(y,Y.startTime-N)}}function w(N,Y){g=!1,x&&(x=!1,f(v),v=-1),p=!0;var j=c;try{for(M(Y),h=n(l);h!==null&&(!(h.expirationTime>Y)||N&&!P());){var te=h.callback;if(typeof te=="function"){h.callback=null,c=h.priorityLevel;var ae=te(h.expirationTime<=Y);Y=t.unstable_now(),typeof ae=="function"?h.callback=ae:h===n(l)&&i(l),M(Y)}else i(l);h=n(l)}if(h!==null)var Be=!0;else{var Je=n(u);Je!==null&&k(y,Je.startTime-Y),Be=!1}return Be}finally{h=null,c=j,p=!1}}var E=!1,A=null,v=-1,R=5,b=-1;function P(){return!(t.unstable_now()-b<R)}function D(){if(A!==null){var N=t.unstable_now();b=N;var Y=!0;try{Y=A(!0,N)}finally{Y?X():(E=!1,A=null)}}else E=!1}var X;if(typeof _=="function")X=function(){_(D)};else if(typeof MessageChannel<"u"){var G=new MessageChannel,O=G.port2;G.port1.onmessage=D,X=function(){O.postMessage(null)}}else X=function(){m(D,0)};function K(N){A=N,E||(E=!0,X())}function k(N,Y){v=m(function(){N(t.unstable_now())},Y)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(N){N.callback=null},t.unstable_continueExecution=function(){g||p||(g=!0,K(w))},t.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<N?Math.floor(1e3/N):5},t.unstable_getCurrentPriorityLevel=function(){return c},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(N){switch(c){case 1:case 2:case 3:var Y=3;break;default:Y=c}var j=c;c=Y;try{return N()}finally{c=j}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(N,Y){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var j=c;c=N;try{return Y()}finally{c=j}},t.unstable_scheduleCallback=function(N,Y,j){var te=t.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?te+j:te):j=te,N){case 1:var ae=-1;break;case 2:ae=250;break;case 5:ae=1073741823;break;case 4:ae=1e4;break;default:ae=5e3}return ae=j+ae,N={id:d++,callback:Y,priorityLevel:N,startTime:j,expirationTime:ae,sortIndex:-1},j>te?(N.sortIndex=j,e(u,N),n(l)===null&&N===n(u)&&(x?(f(v),v=-1):x=!0,k(y,j-te))):(N.sortIndex=ae,e(l,N),g||p||(g=!0,K(w))),N},t.unstable_shouldYield=P,t.unstable_wrapCallback=function(N){var Y=c;return function(){var j=c;c=Y;try{return N.apply(this,arguments)}finally{c=j}}}})(tg);eg.exports=tg;var _v=eg.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const TS=ke.forwardRef(({color:t="currentColor",size:e=24,strokeWidth:n=2,absoluteStrokeWidth:i,className:r="",children:s,iconNode:a,...o},l)=>ke.createElement("svg",{ref:l,...ES,width:e,height:e,stroke:t,strokeWidth:i?Number(n)*24/Number(e):n,className:e_("lucide",r),...o},[...a.map(([u,d])=>ke.createElement(u,d)),...Array.isArray(s)?s:[s]]));/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qd=(t,e)=>{const n=ke.forwardRef(({className:i,...r},s)=>ke.createElement(TS,{ref:s,iconNode:e,className:e_(`lucide-${MS(t)}`,i),...r}));return n.displayName=`${t}`,n};/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
void main() {
	...
	`}class U_ extends oi{constructor(e=1,n={}){super(e,e,n),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new b_(r),this._setTextureOptions(n),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,n){this.texture.type=n.type,this.texture.colorSpace=n.colorSpace,this.texture.generateMipmaps=n.generateMipmaps,this.texture.minFilter=n.minFilter,this.texture.magFilter=n.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new qa(5,5,5),s=new Yn({name:"CubemapFromEquirect",uniforms:Fs(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:fn,blending:Ei});s.uniforms.tEquirect.value=n;const a=new ci(r,s),o=n.minFilter;return n.minFilter===Ar&&(n.minFilter=Kt),new p1(1,10,this).update(e,a),n.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,n=!0,i=!0,r=!0){const s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(n,i,r);e.setRenderTarget(s)}}function cw(t){let e=new WeakMap,n=new WeakMap,i=null;function r(c,p=!1){return c==null?null:p?a(c):s(c)}function s(c){if(c&&c.isTexture){const p=c.mapping;if(p===Iu||p===Nu)if(e.has(c)){const g=e.get(c).texture;return o(g,c.mapping)}else{const g=c.image;if(g&&g.height>0){const x=new U_(g.height);return x.fromEquirectangularTexture(t,c),e.set(c,x),c.addEventListener("dispose",u),o(x.texture,c.mapping)}else return null}}return c}function a(c){if(c&&c.isTexture){const p=c.mapping,g=p===Iu||p===Nu,x=p===Ur||p===Ns;if(g||x){let m=n.get(c);const f=m!==void 0?m.texture.pmremVersion:0;if(c.isRenderTargetTexture&&c.pmremVersion!==f)return i===null&&(i=new ym(t)),m=g?i.fromEquirectangular(c,m):i.fromCubemap(c,m),m.texture.pmremVersion=c.pmremVersion,n.set(c,m),m.texture;if(m!==void 0)return m.texture;{const _=c.image;return g&&_&&_.height>0||x&&_&&l(_)?(i===null&&(i=new ym(t)),m=g?i.fromEquirectangular(c):i.fromCubemap(c),m.texture.pmremVersion=c.pmremVersion,n.set(c,m),c.addEventListener("dispose",d),m.texture):null}}}return c}function o(c,p){return p===Iu?c.mapping=Ur:p===Nu&&(c.mapping=Ns),c}function l(c){let p=0;const g=6;for(let x=0;x<g;x++)c[x]!==void 0&&p++;return p===g}function u(c){const p=c.target;p.removeEventListener("dispose",u);const g=e.get(p);g!==void 0&&(e.delete(p),g.dispose())}function d(c){const p=c.target;p.removeEventListener("dispose",d);const g=n.get(p);g!==void 0&&(n.delete(p),g.dispose())}function h(){e=new WeakMap,n=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:h}}function fw(t){const e={};function n(i){if(e[i]!==void 0)return e[i];const r=t.getExtension(i);return e[i]=r,r}return{has:function(i){return n(i)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(i){const r=n(i);return r===null&&Ts("WebGLRenderer: "+i+" extension not supported."),r}}}function dw(t,e,n,i){const r={},s=new WeakMap;function a(h){const c=h.target;c.index!==null&&e.remove(c.index);for(const g in c.attributes)e.remove(c.attributes[g]);c.removeEventListener("dispose",a),delete r[c.id];const p=s.get(c);p&&(e.remove(p),s.delete(c)),i.releaseStatesOfGeometry(c),c.isInstancedBufferGeometry===!0&&delete c._maxInstanceCount,n.memory.geometries--}function o(h,c){return r[c.id]===!0||(c.addEventListener("dispose",a),r[c.id]=!0,n.memory.geometries++),c}function l(h){const c=h.attributes;for(const p in c)e.update(c[p],t.ARRAY_BUFFER)}function u(h){const c=[],p=h.index,g=h.attributes.position;let x=0;if(g===void 0)return;if(p!==null){const _=p.array;x=p.version;for(let M=0,y=_.length;M<y;M+=3){const w=_[M+0],E=_[M+1],A=_[M+2];c.push(w,E,E,A,A,w)}}else{const _=g.array;x=g.version;for(let M=0,y=_.length/3-1;M<y;M+=3){const w=M+0,E=M+1,A=M+2;c.push(w,E,E,A,A,w)}}const m=new(g.count>=65535?A_:w_)(c,1);m.version=x;const f=s.get(h);f&&e.remove(f),s.set(h,m)}function d(h){const c=s.get(h);if(c){const p=h.index;p!==null&&c.version<p.version&&u(h)}else u(h);return s.get(h)}return{get:o,update:l,getWireframeAttribute:d}}function hw(t,e,n){let i;function r(h){i=h}let s,a;function o(h){s=h.type,a=h.bytesPerElement}function l(h,c){t.drawElements(i,c,s,h*a),n.update(c,i,1)}function u(h,c,p){p!==0&&(t.drawElementsInstanced(i,c,s,h*a,p),n.update(c,i,p))}function d(h,c,p){if(p===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,c,0,s,h,0,p);let x=0;for(let m=0;m<p;m++)x+=c[m];n.update(x,i,1)}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=u,this.renderMultiDraw=d}function pw(t){const e={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(n.calls++,a){case t.TRIANGLES:n.triangles+=o*(s/3);break;case t.LINES:n.lines+=o*(s/2);break;case t.LINE_STRIP:n.lines+=o*(s-1);break;case t.LINE_LOOP:n.lines+=o*s;break;case t.POINTS:n.points+=o*s;break;default:Ye("WebGLInfo: Unknown draw mode:",a);break}}function r(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:e,render:n,programs:null,autoReset:!0,reset:r,update:i}}function mw(t,e,n){const i=new WeakMap,r=new xt;function s(a,o,l){const u=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=d!==void 0?d.length:0;let c=i.get(o);if(c===void 0||c.count!==h){let b=function(){v.dispose(),i.delete(o),o.removeEventListener("dispose",b)};var p=b;c!==void 0&&c.texture.dispose();const g=o.morphAttributes.position!==void 0,x=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,f=o.morphAttributes.position||[],_=o.morphAttributes.normal||[],M=o.morphAttributes.color||[];let y=0;g===!0&&(y=1),x===!0&&(y=2),m===!0&&(y=3);let w=o.attributes.position.count*y,E=1;w>e.maxTextureSize&&(E=Math.ceil(w/e.maxTextureSize),w=e.maxTextureSize);const A=new Float32Array(w*E*4*h),v=new M_(A,w,E,h);v.type=ni,v.needsUpdate=!0;const R=y*4;for(let P=0;P<h;P++){const D=f[P],X=_[P],G=M[P],O=w*E*4*P;for(let K=0;K<D.count;K++){const k=K*R;g===!0&&(r.fromBufferAttribute(D,K),A[O+k+0]=r.x,A[O+k+1]=r.y,A[O+k+2]=r.z,A[O+k+3]=0),x===!0&&(r.fromBufferAttribute(X,K),A[O+k+4]=r.x,A[O+k+5]=r.y,A[O+k+6]=r.z,A[O+k+7]=0),m===!0&&(r.fromBufferAttribute(G,K),A[O+k+8]=r.x,A[O+k+9]=r.y,A[O+k+10]=r.z,A[O+k+11]=G.itemSize===4?r.w:1)}}c={count:h,texture:v,size:new $e(w,E)},i.set(o,c),o.addEventListener("dispose",b)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(t,"morphTexture",a.morphTexture,n);else{let g=0;for(let m=0;m<u.length;m++)g+=u[m];const x=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(t,"morphTargetBaseInfluence",x),l.getUniforms().setValue(t,"morphTargetInfluences",u)}l.getUniforms().setValue(t,"morphTargetsTexture",c.texture,n),l.getUniforms().setValue(t,"morphTargetsTextureSize",c.size)}return{update:s}}function gw(t,e,n,i,r){let s=new WeakMap;function a(u){const d=r.render.frame,h=u.geometry,c=e.get(u,h);if(s.get(c)!==d&&(e.update(c),s.set(c,d)),u.isInstancedMesh&&(u.hasEventListener("dispose",l)===!1&&u.addEventListener("dispose",l),s.get(u)!==d&&(n.update(u.instanceMatrix,t.ARRAY_BUFFER),u.instanceColor!==null&&n.update(u.instanceColor,t.ARRAY_BUFFER),s.set(u,d))),u.isSkinnedMesh){const p=u.skeleton;s.get(p)!==d&&(p.update(),s.set(p,d))}return c}function o(){s=new WeakMap}function l(u){const d=u.target;d.removeEventListener("dispose",l),i.releaseStatesOfObject(d),n.remove(d.instanceMatrix),d.instanceColor!==null&&n.remove(d.instanceColor)}return{update:a,dispose:o}}const _w={[a_]:"LINEAR_TONE_MAPPING",[o_]:"REINHARD_TONE_MAPPING",[l_]:"CINEON_TONE_MAPPING",[u_]:"ACES_FILMIC_TONE_MAPPING",[f_]:"AGX_TONE_MAPPING",[d_]:"NEUTRAL_TONE_MAPPING",[c_]:"CUSTOM_TONE_MAPPING"};function vw(t,e,n,i,r,s){const a=new oi(e,n,{type:t,depthBuffer:r,stencilBuffer:s,samples:i?4:0,depthTexture:r?new Us(e,n):void 0}),o=new oi(e,n,{type:Pi,depthBuffer:!1,stencilBuffer:!1}),l=new Ii;l.setAttribute("position",new wi([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute("uv",new wi([0,2,0,0,2,0],2));const u=new f1({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)+`
`+m,f=["#define varying in",n.glslVersion===Qp?"":"layout(location = 0) out highp vec4 pc_fragColor;",n.glslVersion===Qp?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+f);const M=_+m+a,y=_+f+o,w=Lm(r,r.VERTEX_SHADER,M),E=Lm(r,r.FRAGMENT_SHADER,y);r.attachShader(x,w),r.attachShader(x,E),n.index0AttributeName!==void 0?r.bindAttribLocation(x,0,n.index0AttributeName):n.hasPositionAttribute===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function A(P){if(t.debug.checkShaderErrors){const D=r.getProgramInfoLog(x)||"",X=r.getShaderInfoLog(w)||"",G=r.getShaderInfoLog(E)||"",O=D.trim(),K=X.trim(),k=G.trim();let N=!0,Y=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(N=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,x,w,E);else{const j=Im(r,w,"vertex"),te=Im(r,E,"fragment");Ye("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
...
}`,QA=[new H(1,0,0),new H(-1,0,0),new H(0,1,0),new H(0,-1,0),new H(0,0,1),new H(0,0,-1)],JA=[new H(0,-1,0),new H(0,-1,0),new H(0,0,1),new H(0,0,-1),new H(0,-1,0),new H(0,-1,0)],Vm=new Ct,ia=new H,fc=new H;function jA(t,e,n){let i=new C_;const r=new $e,s=new $e,a=new xt,o=new d1,l=new h1,u={},d=n.maxTextureSize,h={[lr]:fn,[fn]:lr,[vi]:vi},c=new Yn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new $e},radius:{value:4}},vertexShader:KA,fragmentShader:ZA}),p=c.clone();p.defines.HORIZONTAL_PASS=1;const g=new Ii;g.setAttribute("position",new li(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new ci(g,c),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Qo;let f=this.type;this.render=function(E,A,v){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||E.length===0)return;this.type===tM&&(be("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Qo);const R=t.getRenderTarget(),b=t.getActiveCubeFace(),P=t.getActiveMipmapLevel(),D=t.state;D.setBlending(Ei),D.buffers.depth.getReversed()===!0?D.buffers.color.setClear(0,0,0,0):D.buffers.color.setClear(1,1,1,1),D.buffers.depth.setTest(!0),D.setScissorTest(!1);const X=f!==this.type;X&&A.traverse(function(G){G.material&&(Array.isArray(G.material)?G.material.forEach(O=>O.needsUpdate=!0):G.material.needsUpdate=!0)});for(let G=0,O=E.length;G<O;G++){const K=E[G],k=K.shadow;if(k===void 0){be("WebGLShadowMap:",K,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;r.copy(k.mapSize);const N=k.getFrameExtents();r.multiply(N),s.copy(k.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/N.x),r.x=s.x*N.x,k.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/N.y),r.y=s.y*N.y,k.mapSize.y=s.y));const Y=t.state.buffers.depth.getReversed();if(k.camera._reversedDepth=Y,k.map===null||X===!0){if(k.map!==null&&(k.map.depthTexture!==null&&(k.map.depthTexture.dispose(),k.map.depthTexture=null),k.map.dispose()),this.type===ua){if(K.isPointLight){be("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}k.map=new oi(r.x,r.y,{format:Fr,type:Pi,minFilter:Kt,magFilter:Kt,generateMipmaps:!1}),k.map.texture.name=K.name+".shadowMap",k.map.depthTexture=new Us(r.x,r.y,ni),k.map.depthTexture.name=K.name+".shadowMapDepth",k.map.depthTexture.format=Li,k.map.depthTexture.compareFunction=null,k.map.depthTexture.minFilter=kt,k.map.depthTexture.magFilter=kt}else K.isPointLight?(k.map=new U_(r.x),k.map.depthTexture=new a1(r.x,ui)):(k.map=new oi(r.x,r.y),k.map.depthTexture=new Us(r.x,r.y,ui)),k.map.depthTexture.name=K.name+".shadowMap",k.map.depthTexture.format=Li,this.type===Qo?(k.map.depthTexture.compareFunction=Y?nh:th,k.map.depthTexture.minFilter=Kt,k.map.depthTexture.magFilter=Kt):(k.map.depthTexture.compareFunction=null,k.map.depthTexture.minFilter=kt,k.map.depthTexture.magFilter=kt);k.camera.updateProjectionMatrix()}const j=k.map.isWebGLCubeRenderTarget?6:1;for(let te=0;te<j;te++){if(k.map.isWebGLCubeRenderTarget)t.setRenderTarget(k.map,te),t.clear();else{te===0&&(t.setRenderTarget(k.map),t.clear());const ae=k.getViewport(te);a.set(s.x*ae.x,s.y*ae.y,s.x*ae.z,s.y*ae.w),D.viewport(a)}if(K.isPointLight){const ae=k.camera,Be=k.matrix,Je=K.distance||ae.far;Je!==ae.far&&(ae.far=Je,ae.updateProjectionMatrix()),ia.setFromMatrixPosition(K.matrixWorld),ae.position.copy(ia),fc.copy(ae.position),fc.add(QA[te]),ae.up.copy(JA[te]),ae.lookAt(fc),ae.updateMatrixWorld(),Be.makeTranslation(-ia.x,-ia.y,-ia.z),Vm.multiplyMatrices(ae.projectionMatrix,ae.matrixWorldInverse),k._frustum.setFromProjectionMatrix(Vm,ae.coordinateSystem,ae.reversedDepth)}else k.updateMatrices(K);i=k.getFrustum(),y(A,v,k.camera,K,this.type)}k.isPointLightShadow!==!0&&this.type===ua&&_(k,v),k.needsUpdate=!1}f=this.type,m.needsUpdate=!1,t.setRenderTarget(R,b,P)};function _(E,A){const v=e.update(x);c.defines.VSM_SAMPLES!==E.blurSamples&&(c.defines.VSM_SAMPLES=E.blurSamples,p.defines.VSM_SAMPLES=E.blurSamples,c.needsUpdate=!0,p.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new oi(r.x,r.y,{format:Fr,type:Pi})),c.uniforms.shadow_pass.value=E.map.depthTexture,c.uniforms.resolution.value=E.mapSize,c.uniforms.radius.value=E.radius,t.setRenderTarget(E.mapPass),t.clear(),t.renderBufferDirect(A,null,v,c,x,null),p.uniforms.shadow_pass.value=E.mapPass.texture,p.uniforms.resolution.value=E.mapSize,p.uniforms.radius.value=E.radius,t.setRenderTarget(E.map),t.clear(),t.renderBufferDirect(A,null,v,p,x,null)}function M(E,A,v,R){let b=null;const P=v.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(P!==void 0)b=P;else if(b=v.isPointLight===!0?l:o,t.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){const D=b.uuid,X=A.uuid;let G=u[D];G===void 0&&(G={},u[D]=G);let O=G[X];O===void 0&&(O=b.clone(),G[X]=O,A.addEventListener("dispose",w)),b=O}if(b.visible=A.visible,b.wireframe=A.wireframe,R===ua?b.side=A.shadowSide!==null?A.shadowSide:A.side:b.side=A.shadowSide!==null?A.shadowSide:h[A.side],b.alphaMap=A.alphaMap,b.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,b.map=A.map,b.clipShadows=A.clipShadows,b.clippingPlanes=A.clippingPlanes,b.clipIntersection=A.clipIntersection,b.displacementMap=A.displacementMap,b.displacementScale=A.displacementScale,b.displacementBias=A.displacementBias,b.wireframeLinewidth=A.wireframeLinewidth,b.linewidth=A.linewidth,v.isPointLight===!0&&b.isMeshDistanceMaterial===!0){const D=t.properties.get(b);D.light=v}return b}function y(E,A,v,R,b){if(E.visible===!1)return;if(E.layers.test(A.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&b===ua)&&(!E.frustumCulled||i.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,E.matrixWorld);const X=e.update(E),G=E.material;if(Array.isArray(G)){const O=X.groups;for(let K=0,k=O.length;K<k;K++){const N=O[K],Y=G[N.materialIndex];if(Y&&Y.visible){const j=M(E,Y,R,b);E.onBeforeShadow(t,E,A,v,X,j,N),t.renderBufferDirect(v,null,X,j,E,N),E.onAfterShadow(t,E,A,v,X,j,N)}}}else if(G.visible){const O=M(E,G,R,b);E.onBeforeShadow(t,E,A,v,X,O,null),t.renderBufferDirect(v,null,X,O,E,null),E.onAfterShadow(t,E,A,v,X,O,null)}}const D=E.children;for(let X=0,G=D.length;X<G;X++)y(D[X],A,v,R,b)}function w(E){E.target.removeEventListener("dispose",w);for(const v in u){const R=u[v],b=E.target.uuid;b in R&&(R[b].dispose(),delete R[b])}}}function eR(t,e){function n(){let L=!1;const oe=new xt;let Q=null;const fe=new xt(0,0,0,0);return{setMask:function(ge){Q!==ge&&!L&&(t.colorMask(ge,ge,ge,ge),Q=ge)},setLocked:function(ge){L=ge},setClear:function(ge,ee,Me,Se,gt){gt===!0&&(ge*=Se,ee*=Se,Me*=Se),oe.set(ge,ee,Me,Se),fe.equals(oe)===!1&&(t.clearColor(ge,ee,Me,Se),fe.copy(oe))},reset:function(){L=!1,Q=null,fe.set(-1,0,0,0)}}}function i(){let L=!1,oe=!1,Q=null,fe=null,ge=null;return{setReversed:function(ee){if(oe!==ee){const Me=e.get("EXT_clip_control");ee?Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.ZERO_TO_ONE_EXT):Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.NEGATIVE_ONE_TO_ONE_EXT),oe=ee;const Se=ge;ge=null,this.setClear(Se)}},getReversed:function(){return oe},setTest:function(ee){ee?ie(t.DEPTH_TEST):Pe(t.DEPTH_TEST)},setMask:function(ee){Q!==ee&&!L&&(t.depthMask(ee),Q=ee)},setFunc:function(ee){if(oe&&(ee=NM[ee]),fe!==ee){switch(ee){case ff:t.depthFunc(t.NEVER);break;case df:t.depthFunc(t.ALWAYS);break;case hf:t.depthFunc(t.LESS);break;case Is:t.depthFunc(t.LEQUAL);break;case pf:t.depthFunc(t.EQUAL);break;case mf:t.depthFunc(t.GEQUAL);break;case gf:t.depthFunc(t.GREATER);break;case _f:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}fe=ee}},setLocked:function(ee){L=ee},setClear:function(ee){ge!==ee&&(ge=ee,oe&&(ee=1-ee),t.clearDepth(ee))},reset:function(){L=!1,Q=null,fe=null,ge=null,oe=!1}}}function r(){let L=!1,oe=null,Q=null,fe=null,ge=null,ee=null,Me=null,Se=null,gt=null;return{setTest:function(at){L||(at?ie(t.STENCIL_TEST):Pe(t.STENCIL_TEST))},setMask:function(at){oe!==at&&!L&&(t.stencilMask(at),oe=at)},setFunc:function(at,qn,$n){(Q!==at||fe!==qn||ge!==$n)&&(t.stencilFunc(at,qn,$n),Q=at,fe=qn,ge=$n)},setOp:function(at,qn,$n){(ee!==at||Me!==qn||Se!==$n)&&(t.stencilOp(at,qn,$n),ee=at,Me=qn,Se=$n)},setLocked:function(at){L=at},setClear:function(at){gt!==at&&(t.clearStencil(at),gt=at)},reset:function(){L=!1,oe=null,Q=null,fe=null,ge=null,ee=null,Me=null,Se=null,gt=null}}}const s=new n,a=new i,o=new r,l=new WeakMap,u=new WeakMap;let d={},h={},c={},p=new WeakMap,g=[],x=null,m=!1,f=null,_=null,M=null,y=null,w=null,E=null,A=null,v=new Qe(0,0,0),R=0,b=!1,P=null,D=null,X=null,G=null,O=null;const K=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let k=!1,N=0;const Y=t.getParameter(t.VERSION);Y.indexOf("WebGL")!==-1?(N=parseFloat(/^WebGL (\d)/.exec(Y)[1]),k=N>=1):Y.indexOf("OpenGL ES")!==-1&&(N=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),k=N>=2);let j=null,te={};const ae=t.getParameter(t.SCISSOR_BOX),Be=t.getParameter(t.VIEWPORT),Je=new xt().fromArray(ae),Ve=new xt().fromArray(Be);function Z(L,oe,Q,fe){const ge=new Uint8Array(4),ee=t.createTexture();t.bindTexture(L,ee),t.texParameteri(L,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(L,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Me=0;Me<Q;Me++)L===t.TEXTURE_3D||L===t.TEXTURE_2D_ARRAY?t.texImage3D(oe,0,t.RGBA,1,1,fe,0,t.RGBA,t.UNSIGNED_BYTE,ge):t.texImage2D(oe+Me,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,ge);return ee}const se={};se[t.TEXTURE_2D]=Z(t.TEXTURE_2D,t.TEXTURE_2D,1),se[t.TEXTURE_CUBE_MAP]=Z(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),se[t.TEXTURE_2D_ARRAY]=Z(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),se[t.TEXTURE_3D]=Z(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ie(t.DEPTH_TEST),a.setFunc(Is),Tt(!1),bt(Xp),ie(t.CULL_FACE),Ze(Ei);function ie(L){d[L]!==!0&&(t.enable(L),d[L]=!0)}function Pe(L){d[L]!==!1&&(t.disable(L),d[L]=!1)}function De(L,oe){return c[L]!==oe?(t.bindFramebuffer(L,oe),c[L]=oe,L===t.DRAW_FRAMEBUFFER&&(c[t.FRAMEBUFFER]=oe),L===t.FRAMEBUFFER&&(c[t.DRAW_FRAMEBUFFER]=oe),!0):!1}function Re(L,oe){let Q=g,fe=!1;if(L){Q=p.get(oe),Q===void 0&&(Q=[],p.set(oe,Q));const ge=L.textures;if(Q.length!==ge.length||Q[0]!==t.COLOR_ATTACHMENT0){for(let ee=0,Me=ge.length;ee<Me;ee++)Q[ee]=t.COLOR_ATTACHMENT0+ee;Q.length=ge.length,fe=!0}}else Q[0]!==t.BACK&&(Q[0]=t.BACK,fe=!0);fe&&t.drawBuffers(Q)}function St(L){return x!==L?(t.useProgram(L),x=L,!0):!1}const ze={[yr]:t.FUNC_ADD,[iM]:t.FUNC_SUBTRACT,[rM]:t.FUNC_REVERSE_SUBTRACT};ze[sM]=t.MIN,ze[aM]=t.MAX;const it={[oM]:t.ZERO,[lM]:t.ONE,[uM]:t.SRC_COLOR,[uf]:t.SRC_ALPHA,[mM]:t.SRC_ALPHA_SATURATE,[hM]:t.DST_COLOR,[fM]:t.DST_ALPHA,[cM]:t.ONE_MINUS_SRC_COLOR,[cf]:t.ONE_MINUS_SRC_ALPHA,[pM]:t.ONE_MINUS_DST_COLOR,[dM]:t.ONE_MINUS_DST_ALPHA,[gM]:t.CONSTANT_COLOR,[_M]:t.ONE_MINUS_CONSTANT_COLOR,[vM]:t.CONSTANT_ALPHA,[xM]:t.ONE_MINUS_CONSTANT_ALPHA};function Ze(L,oe,Q,fe,ge,ee,Me,Se,gt,at){if(L===Ei){m===!0&&(Pe(t.BLEND),m=!1);return}if(m===!1&&(ie(t.BLEND),m=!0),L!==nM){if(L!==f||at!==b){if((_!==yr||w!==yr)&&(t.blendEquation(t.FUNC_ADD),_=yr,w=yr),at)switch(L){case Es:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case lf:t.blendFunc(t.ONE,t.ONE);break;case Yp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case qp:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:Ye("WebGLState: Invalid blending: ",L);break}else switch(L){case Es:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case lf:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case Yp:Ye("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case qp:Ye("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ye("WebGLState: Invalid blending: ",L);break}M=null,y=null,E=null,A=null,v.set(0,0,0),R=0,f=L,b=at}return}ge=ge||oe,ee=ee||Q,Me=Me||fe,(oe!==_||ge!==w)&&(t.blendEquationSeparate(ze[oe],ze[ge]),_=oe,w=ge),(Q!==M||fe!==y||ee!==E||Me!==A)&&(t.blendFuncSeparate(it[Q],it[fe],it[ee],it[Me]),M=Q,y=fe,E=ee,A=Me),(Se.equals(v)===!1||gt!==R)&&(t.blendColor(Se.r,Se.g,Se.b,gt),v.copy(Se),R=gt),f=L,b=!1}function We(L,oe){L.side===vi?Pe(t.CULL_FACE):ie(t.CULL_FACE);let Q=L.side===fn;oe&&(Q=!Q),Tt(Q),L.blending===Es&&L.transparent===!1?Ze(Ei):Ze(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),a.setFunc(L.depthFunc),a.setTest(L.depthTest),a.setMask(L.depthWrite),s.setMask(L.colorWrite);const fe=L.stencilWrite;o.setTest(fe),fe&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),Bt(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?ie(t.SAMPLE_ALPHA_TO_COVERAGE):Pe(t.SAMPLE_ALPHA_TO_COVERAGE)}function Tt(L){P!==L&&(L?t.frontFace(t.CW):t.frontFace(t.CCW),P=L)}function bt(L){L!==jy?(ie(t.CULL_FACE),L!==D&&(L===Xp?t.cullFace(t.BACK):L===eM?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Pe(t.CULL_FACE),D=L}function Nt(L){L!==X&&(k&&t.lineWidth(L),X=L)}function Bt(L,oe,Q){L?(ie(t.POLYGON_OFFSET_FILL),(G!==oe||O!==Q)&&(G=oe,O=Q,a.getReversed()&&(oe=-oe),t.polygonOffset(oe,Q))):Pe(t.POLYGON_OFFSET_FILL)}function mt(L){L?ie(t.SCISSOR_TEST):Pe(t.SCISSOR_TEST)}function wt(L){L===void 0&&(L=t.TEXTURE0+K-1),j!==L&&(t.activeTexture(L),j=L)}function I(L,oe,Q){Q===void 0&&(j===null?Q=t.TEXTURE0+K-1:Q=j);let fe=te[Q];fe===void 0&&(fe={type:void 0,texture:void 0},te[Q]=fe),(fe.type!==L||fe.texture!==oe)&&(j!==Q&&(t.activeTexture(Q),j=Q),t.bindTexture(L,oe||se[L]),fe.type=L,fe.texture=oe)}function rn(){const L=te[j];L!==void 0&&L.type!==void 0&&(t.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function je(){try{t.compressedTexImage2D(...arguments)}catch(L){Ye("WebGLState:",L)}}function C(){try{t.compressedTexImage3D(...arguments)}catch(L){Ye("WebGLState:",L)}}function S(){try{t.texSubImage2D(...arguments)}catch(L){Ye("WebGLState:",L)}}function F(){try{t.texSubImage3D(...arguments)}catch(L){Ye("WebGLState:",L)}}function V(){try{t.compressedTexSubImage2D(...arguments)}catch(L){Ye("WebGLState:",L)}}function q(){try{t.compressedTexSubImage3D(...arguments)}catch(L){Ye("WebGLState:",L)}}function re(){try{t.texStorage2D(...arguments)}catch(L){Ye("WebGLState:",L)}}function le(){try{t.texStorage3D(...arguments)}catch(L){Ye("WebGLState:",L)}}function $(){try{t.texImage2D(...arguments)}catch(L){Ye("WebGLState:",L)}}function J(){try{t.texImage3D(...arguments)}catch(L){Ye("WebGLState:",L)}}function ue(L){return h[L]!==void 0?h[L]:t.getParameter(L)}function Ee(L,oe){h[L]!==oe&&(t.pixelStorei(L,oe),h[L]=oe)}function de(L){Je.equals(L)===!1&&(t.scissor(L.x,L.y,L.z,L.w),Je.copy(L))}function ce(L){Ve.equals(L)===!1&&(t.viewport(L.x,L.y,L.z,L.w),Ve.copy(L))}function Ae(L,oe){let Q=u.get(oe);Q===void 0&&(Q=new WeakMap,u.set(oe,Q));let fe=Q.get(L);fe===void 0&&(fe=t.getUniformBlockIndex(oe,L.name),Q.set(L,fe))}function Ce(L,oe){const fe=u.get(oe).get(L);l.get(oe)!==fe&&(t.uniformBlockBinding(oe,fe,L.__bindingPointIndex),l.set(oe,fe))}function Ie(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),a.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),d={},h={},j=null,te={},c={},p=new WeakMap,g=[],x=null,m=!1,f=null,_=null,M=null,y=null,w=null,E=null,A=null,v=new Qe(0,0,0),R=0,b=!1,P=null,D=null,X=null,G=null,O=null,Je.set(0,0,t.canvas.width,t.canvas.height),Ve.set(0,0,t.canvas.width,t.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:ie,disable:Pe,bindFramebuffer:De,drawBuffers:Re,useProgram:St,setBlending:Ze,setMaterial:We,setFlipSided:Tt,setCullFace:bt,setLineWidth:Nt,setPolygonOffset:Bt,setScissorTest:mt,activeTexture:wt,bindTexture:I,unbindTexture:rn,compressedTexImage2D:je,compressedTexImage3D:C,texImage2D:$,texImage3D:J,pixelStorei:Ee,getParameter:ue,updateUBOMapping:Ae,uniformBlockBinding:Ce,texStorage2D:re,texStorage3D:le,texSubImage2D:S,texSubImage3D:F,compressedTexSubImage2D:V,compressedTexSubImage3D:q,scissor:de,viewport:ce,reset:Ie}}function tR(t,e,n,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new $e,d=new WeakMap,h=new Set;let c;const p=new WeakMap;let g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(C,S){return g?new OffscreenCanvas(C,S):Il("canvas")}function m(C,S,F){let V=1;const q=je(C);if((q.width>F||q.height>F)&&(V=F/Math.max(q.width,q.height)),V<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const re=Math.floor(V*q.width),le=Math.floor(V*q.height);c===void 0&&(c=x(re,le));const $=S?x(re,le):c;return $.width=re,$.height=le,$.getContext("2d").drawImage(C,0,0,re,le),be("WebGLRenderer: Texture has been resized from ("+q.width+"x"+q.height+") to ("+re+"x"+le+")."),$}else return"data"in C&&be("WebGLRenderer: Image in DataTexture is too big ("+q.width+"x"+q.height+")."),C;return C}function f(C){return C.generateMipmaps}function _(C){t.generateMipmap(C)}function M(C){return C.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?t.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function y(C,S,F,V,q,re=!1){if(C!==null){if(t[C]!==void 0)return t[C];be("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let le;V&&(le=e.get("EXT_texture_norm16"),le||be("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let $=S;if(S===t.RED&&(F===t.FLOAT&&($=t.R32F),F===t.HALF_FLOAT&&($=t.R16F),F===t.UNSIGNED_BYTE&&($=t.R8),F===t.UNSIGNED_SHORT&&le&&($=le.R16_EXT),F===t.SHORT&&le&&($=le.R16_SNORM_EXT)),S===t.RED_INTEGER&&(F===t.UNSIGNED_BYTE&&($=t.R8UI),F===t.UNSIGNED_SHORT&&($=t.R16UI),F===t.UNSIGNED_INT&&($=t.R32UI),F===t.BYTE&&($=t.R8I),F===t.SHORT&&($=t.R16I),F===t.INT&&($=t.R32I)),S===t.RG&&(F===t.FLOAT&&($=t.RG32F),F===t.HALF_FLOAT&&($=t.RG16F),F===t.UNSIGNED_BYTE&&($=t.RG8),F===t.UNSIGNED_SHORT&&le&&($=le.RG16_EXT),F===t.SHORT&&le&&($=le.RG16_SNORM_EXT)),S===t.RG_INTEGER&&(F===t.UNSIGNED_BYTE&&($=t.RG8UI),F===t.UNSIGNED_SHORT&&($=t.RG16UI),F===t.UNSIGNED_INT&&($=t.RG32UI),F===t.BYTE&&($=t.RG8I),F===t.SHORT&&($=t.RG16I),F===t.INT&&($=t.RG32I)),S===t.RGB_INTEGER&&(F===t.UNSIGNED_BYTE&&($=t.RGB8UI),F===t.UNSIGNED_SHORT&&($=t.RGB16UI),F===t.UNSIGNED_INT&&($=t.RGB32UI),F===t.BYTE&&($=t.RGB8I),F===t.SHORT&&($=t.RGB16I),F===t.INT&&($=t.RGB32I)),S===t.RGBA_INTEGER&&(F===t.UNSIGNED_BYTE&&($=t.RGBA8UI),F===t.UNSIGNED_SHORT&&($=t.RGBA16UI),F===t.UNSIGNED_INT&&($=t.RGBA32UI),F===t.BYTE&&($=t.RGBA8I),F===t.SHORT&&($=t.RGBA16I),F===t.INT&&($=t.RGBA32I)),S===t.RGB&&(F===t.UNSIGNED_SHORT&&le&&($=le.RGB16_EXT),F===t.SHORT&&le&&($=le.RGB16_SNORM_EXT),F===t.UNSIGNED_INT_5_9_9_9_REV&&($=t.RGB9_E5),F===t.UNSIGNED_INT_10F_11F_11F_REV&&($=t.R11F_G11F_B10F)),S===t.RGBA){const J=re?Ll:He.getTransfer(q);F===t.FLOAT&&($=t.RGBA32F),F===t.HALF_FLOAT&&($=t.RGBA16F),F===t.UNSIGNED_BYTE&&($=J===et?t.SRGB8_ALPHA8:t.RGBA8),F===t.UNSIGNED_SHORT&&le&&($=le.RGBA16_EXT),F===t.SHORT&&le&&($=le.RGBA16_SNORM_EXT),F===t.UNSIGNED_SHORT_4_4_4_4&&($=t.RGBA4),F===t.UNSIGNED_SHORT_5_5_5_1&&($=t.RGB5_A1)}return($===t.R16F||$===t.R32F||$===t.RG16F||$===t.RG32F||$===t.RGBA16F||$===t.RGBA32F)&&e.get("EXT_color_buffer_float"),$}function w(C,S){let F;return C?S===null||S===ui||S===za?F=t.DEPTH24_STENCIL8:S===ni?F=t.DEPTH32F_STENCIL8:S===Ba&&(F=t.DEPTH24_STENCIL8,be("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===ui||S===za?F=t.DEPTH_COMPONENT24:S===ni?F=t.DEPTH_COMPONENT32F:S===Ba&&(F=t.DEPTH_COMPONENT16),F}function E(C,S){return f(C)===!0||C.isFramebufferTexture&&C.minFilter!==kt&&C.minFilter!==Kt?Math.log2(Math.max(S.width,S.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?S.mipmaps.length:1}function A(C){const S=C.target;S.removeEventListener("dispose",A),R(S),S.isVideoTexture&&d.delete(S),S.isHTMLTexture&&h.delete(S)}function v(C){const S=C.target;S.removeEventListener("dispose",v),P(S)}function R(C){const S=i.get(C);if(S.__webglInit===void 0)return;const F=C.source,V=p.get(F);if(V){const q=V[S.__cacheKey];q.usedTimes--,q.usedTimes===0&&b(C),Object.keys(V).length===0&&p.delete(F)}i.remove(C)}function b(C){const S=i.get(C);t.deleteTexture(S.__webglTexture);const F=C.source,V=p.get(F);delete V[S.__cacheKey],a.memory.textures--}function P(C){const S=i.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),i.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let V=0;V<6;V++){if(Array.isArray(S.__webglFramebuffer[V]))for(let q=0;q<S.__webglFramebuffer[V].length;q++)t.deleteFramebuffer(S.__webglFramebuffer[V][q]);else t.deleteFramebuffer(S.__webglFramebuffer[V]);S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer[V])}else{if(Array.isArray(S.__webglFramebuffer))for(let V=0;V<S.__webglFramebuffer.length;V++)t.deleteFramebuffer(S.__webglFramebuffer[V]);else t.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&t.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let V=0;V<S.__webglColorRenderbuffer.length;V++)S.__webglColorRenderbuffer[V]&&t.deleteRenderbuffer(S.__webglColorRenderbuffer[V]);S.__webglDepthRenderbuffer&&t.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const F=C.textures;for(let V=0,q=F.length;V<q;V++){const re=i.get(F[V]);re.__webglTexture&&(t.deleteTexture(re.__webglTexture),a.memory.textures--),i.remove(F[V])}i.remove(C)}let D=0;function X(){D=0}function G(){return D}function O(C){D=C}function K(){const C=D;return C>=r.maxTextures&&be("WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+r.maxTextures),D+=1,C}function k(C){const S=[];return S.push(C.wrapS),S.push(C.wrapT),S.push(C.wrapR||0),S.push(C.magFilter),S.push(C.minFilter),S.push(C.anisotropy),S.push(C.internalFormat),S.push(C.format),S.push(C.type),S.push(C.generateMipmaps),S.push(C.premultiplyAlpha),S.push(C.flipY),S.push(C.unpackAlignment),S.push(C.colorSpace),S.join()}function N(C,S){const F=i.get(C);if(C.isVideoTexture&&I(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&F.__version!==C.version){const V=C.image;if(V===null)be("WebGLRenderer: Texture marked for update but no image data found.");else if(V.complete===!1)be("WebGLRenderer: Texture marked for update but image is incomplete");else{Pe(F,C,S);return}}else C.isExternalTexture&&(F.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,F.__webglTexture,t.TEXTURE0+S)}function Y(C,S){const F=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&F.__version!==C.version){Pe(F,C,S);return}else C.isExternalTexture&&(F.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,F.__webglTexture,t.TEXTURE0+S)}function j(C,S){const F=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&F.__version!==C.version){Pe(F,C,S);return}n.bindTexture(t.TEXTURE_3D,F.__webglTexture,t.TEXTURE0+S)}function te(C,S){const F=i.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&F.__version!==C.version){De(F,C,S);return}n.bindTexture(t.TEXTURE_CUBE_MAP,F.__webglTexture,t.TEXTURE0+S)}const ae={[vf]:t.REPEAT,[yi]:t.CLAMP_TO_EDGE,[xf]:t.MIRRORED_REPEAT},Be={[kt]:t.NEAREST,[MM]:t.NEAREST_MIPMAP_NEAREST,[go]:t.NEAREST_MIPMAP_LINEAR,[Kt]:t.LINEAR,[Uu]:t.LINEAR_MIPMAP_NEAREST,[Ar]:t.LINEAR_MIPMAP_LINEAR},Je={[wM]:t.NEVER,[PM]:t.ALWAYS,[AM]:t.LESS,[th]:t.LEQUAL,[RM]:t.EQUAL,[nh]:t.GEQUAL,[CM]:t.GREATER,[bM]:t.NOTEQUAL};function Ve(C,S){if(S.type===ni&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===Kt||S.magFilter===Uu||S.magFilter===go||S.magFilter===Ar||S.minFilter===Kt||S.minFilter===Uu||S.minFilter===go||S.minFilter===Ar)&&be("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(C,t.TEXTURE_WRAP_S,ae[S.wrapS]),t.texParameteri(C,t.TEXTURE_WRAP_T,ae[S.wrapT]),(C===t.TEXTURE_3D||C===t.TEXTURE_2D_ARRAY)&&t.texParameteri(C,t.TEXTURE_WRAP_R,ae[S.wrapR]),t.texParameteri(C,t.TEXTURE_MAG_FILTER,Be[S.magFilter]),t.texParameteri(C,t.TEXTURE_MIN_FILTER,Be[S.minFilter]),S.compareFunction&&(t.texParameteri(C,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(C,t.TEXTURE_COMPARE_FUNC,Je[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===kt||S.minFilter!==go&&S.minFilter!==Ar||S.type===ni&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");t.texParameterf(C,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function Z(C,S){let F=!1;C.__webglInit===void 0&&(C.__webglInit=!0,S.addEventListener("dispose",A));const V=S.source;let q=p.get(V);q===void 0&&(q={},p.set(V,q));const re=k(S);if(re!==C.__cacheKey){q[re]===void 0&&(q[re]={texture:t.createTexture(),usedTimes:0},a.memory.textures++,F=!0),q[re].usedTimes++;const le=q[C.__cacheKey];le!==void 0&&(q[C.__cacheKey].usedTimes--,le.usedTimes===0&&b(S)),C.__cacheKey=re,C.__webglTexture=q[re].texture}return F}function se(C,S,F){return Math.floor(Math.floor(C/F)/S)}function ie(C,S,F,V){const re=C.updateRanges;if(re.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,S.width,S.height,F,V,S.data);else{re.sort((Ee,de)=>Ee.start-de.start);let le=0;for(let Ee=1;Ee<re.length;Ee++){const de=re[le],ce=re[Ee],Ae=de.start+de.count,Ce=se(ce.start,S.width,4),Ie=se(de.start,S.width,4);ce.start<=Ae+1&&Ce===Ie&&se(ce.start+ce.count-1,S.width,4)===Ce?de.count=Math.max(de.count,ce.start+ce.count-de.start):(++le,re[le]=ce)}re.length=le+1;const $=n.getParameter(t.UNPACK_ROW_LENGTH),J=n.getParameter(t.UNPACK_SKIP_PIXELS),ue=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,S.width);for(let Ee=0,de=re.length;Ee<de;Ee++){const ce=re[Ee],Ae=Math.floor(ce.start/4),Ce=Math.ceil(ce.count/4),Ie=Ae%S.width,L=Math.floor(Ae/S.width),oe=Ce,Q=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,Ie),n.pixelStorei(t.UNPACK_SKIP_ROWS,L),n.texSubImage2D(t.TEXTURE_2D,0,Ie,L,oe,Q,F,V,S.data)}C.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,$),n.pixelStorei(t.UNPACK_SKIP_PIXELS,J),n.pixelStorei(t.UNPACK_SKIP_ROWS,ue)}}function Pe(C,S,F){let V=t.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(V=t.TEXTURE_2D_ARRAY),S.isData3DTexture&&(V=t.TEXTURE_3D);const q=Z(C,S),re=S.source;n.bindTexture(V,C.__webglTexture,t.TEXTURE0+F);const le=i.get(re);if(re.version!==le.__version||q===!0){if(n.activeTexture(t.TEXTURE0+F),(typeof ImageBitmap<"u"&&S.image instanceof ImageBitmap)===!1){const Q=He.getPrimaries(He.workingColorSpace),fe=S.colorSpace===$i?null:He.getPrimaries(S.colorSpace),ge=S.colorSpace===$i||Q===fe?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,ge)}n.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment);let J=m(S.image,!1,r.maxTextureSize);J=rn(S,J);const ue=s.convert(S.format,S.colorSpace),Ee=s.convert(S.type);let de=y(S.internalFormat,ue,Ee,S.normalized,S.colorSpace,S.isVideoTexture);Ve(V,S);let ce;const Ae=S.mipmaps,Ce=S.isVideoTexture!==!0,Ie=le.__version===void 0||q===!0,L=re.dataReady,oe=E(S,J);if(S.isDepthTexture)de=w(S.format===Rr,S.type),Ie&&(Ce?n.texStorage2D(t.TEXTURE_2D,1,de,J.width,J.height):n.texImage2D(t.TEXTURE_2D,0,de,J.width,J.height,0,ue,Ee,null));else if(S.isDataTexture)if(Ae.length>0){Ce&&Ie&&n.texStorage2D(t.TEXTURE_2D,oe,de,Ae[0].width,Ae[0].height);for(let Q=0,fe=Ae.length;Q<fe;Q++)ce=Ae[Q],Ce?L&&n.texSubImage2D(t.TEXTURE_2D,Q,0,0,ce.width,ce.height,ue,Ee,ce.data):n.texImage2D(t.TEXTURE_2D,Q,de,ce.width,ce.height,0,ue,Ee,ce.data);S.generateMipmaps=!1}else Ce?(Ie&&n.texStorage2D(t.TEXTURE_2D,oe,de,J.width,J.height),L&&ie(S,J,ue,Ee)):n.texImage2D(t.TEXTURE_2D,0,de,J.width,J.height,0,ue,Ee,J.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){Ce&&Ie&&n.texStorage3D(t.TEXTURE_2D_ARRAY,oe,de,Ae[0].width,Ae[0].height,J.depth);for(let Q=0,fe=Ae.length;Q<fe;Q++)if(ce=Ae[Q],S.format!==Hn)if(ue!==null)if(Ce){if(L)if(S.layerUpdates.size>0){const ge=vm(ce.width,ce.height,S.format,S.type);for(const ee of S.layerUpdates){const Me=ce.data.subarray(ee*ge/ce.data.BYTES_PER_ELEMENT,(ee+1)*ge/ce.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,Q,0,0,ee,ce.width,ce.height,1,ue,Me)}S.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,Q,0,0,0,ce.width,ce.height,J.depth,ue,ce.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,Q,de,ce.width,ce.height,J.depth,0,ce.data,0,0);else be("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ce?L&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,Q,0,0,0,ce.width,ce.height,J.depth,ue,Ee,ce.data):n.texImage3D(t.TEXTURE_2D_ARRAY,Q,de,ce.width,ce.height,J.depth,0,ue,Ee,ce.data)}else{Ce&&Ie&&n.texStorage2D(t.TEXTURE_2D,oe,de,Ae[0].width,Ae[0].height);for(let Q=0,fe=Ae.length;Q<fe;Q++)ce=Ae[Q],S.format!==Hn?ue!==null?Ce?L&&n.compressedTexSubImage2D(t.TEXTURE_2D,Q,0,0,ce.width,ce.height,ue,ce.data):n.compressedTexImage2D(t.TEXTURE_2D,Q,de,ce.width,ce.height,0,ce.data):be("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ce?L&&n.texSubImage2D(t.TEXTURE_2D,Q,0,0,ce.width,ce.height,ue,Ee,ce.data):n.texImage2D(t.TEXTURE_2D,Q,de,ce.width,ce.height,0,ue,Ee,ce.data)}else if(S.isDataArrayTexture)if(Ce){if(Ie&&n.texStorage3D(t.TEXTURE_2D_ARRAY,oe,de,J.width,J.height,J.depth),L)if(S.layerUpdates.size>0){const Q=vm(J.width,J.height,S.format,S.type);for(const fe of S.layerUpdates){const ge=J.data.subarray(fe*Q/J.data.BYTES_PER_ELEMENT,(fe+1)*Q/J.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,fe,J.width,J.height,1,ue,Ee,ge)}S.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,ue,Ee,J.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,de,J.width,J.height,J.depth,0,ue,Ee,J.data);else if(S.isData3DTexture)Ce?(Ie&&n.texStorage3D(t.TEXTURE_3D,oe,de,J.width,J.height,J.depth),L&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,ue,Ee,J.data)):n.texImage3D(t.TEXTURE_3D,0,de,J.width,J.height,J.depth,0,ue,Ee,J.data);else if(S.isFramebufferTexture){if(Ie)if(Ce)n.texStorage2D(t.TEXTURE_2D,oe,de,J.width,J.height);else{let Q=J.width,fe=J.height;for(let ge=0;ge<oe;ge++)n.texImage2D(t.TEXTURE_2D,ge,de,Q,fe,0,ue,Ee,null),Q>>=1,fe>>=1}}else if(S.isHTMLTexture){if("texElementImage2D"in t){const Q=t.canvas;if(Q.hasAttribute("layoutsubtree")||Q.setAttribute("layoutsubtree","true"),J.parentNode!==Q){Q.appendChild(J),h.add(S),Q.onpaint=fe=>{const ge=fe.changedElements;for(const ee of h)ge.includes(ee.image)&&(ee.needsUpdate=!0)},Q.requestPaint();return}if(t.texElementImage2D.length===3)t.texElementImage2D(t.TEXTURE_2D,t.RGBA8,J);else{const ge=t.RGBA,ee=t.RGBA,Me=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,0,ge,ee,Me,J)}t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(Ae.length>0){if(Ce&&Ie){const Q=je(Ae[0]);n.texStorage2D(t.TEXTURE_2D,oe,de,Q.width,Q.height)}for(let Q=0,fe=Ae.length;Q<fe;Q++)ce=Ae[Q],Ce?L&&n.texSubImage2D(t.TEXTURE_2D,Q,0,0,ue,Ee,ce):n.texImage2D(t.TEXTURE_2D,Q,de,ue,Ee,ce);S.generateMipmaps=!1}else if(Ce){if(Ie){const Q=je(J);n.texStorage2D(t.TEXTURE_2D,oe,de,Q.width,Q.height)}L&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ue,Ee,J)}else n.texImage2D(t.TEXTURE_2D,0,de,ue,Ee,J);f(S)&&_(V),le.__version=re.version,S.onUpdate&&S.onUpdate(S)}C.__version=S.version}function De(C,S,F){if(S.image.length!==6)return;const V=Z(C,S),q=S.source;n.bindTexture(t.TEXTURE_CUBE_MAP,C.__webglTexture,t.TEXTURE0+F);const re=i.get(q);if(q.version!==re.__version||V===!0){n.activeTexture(t.TEXTURE0+F);const le=He.getPrimaries(He.workingColorSpace),$=S.colorSpace===$i?null:He.getPrimaries(S.colorSpace),J=S.colorSpace===$i||le===$?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,J);const ue=S.isCompressedTexture||S.image[0].isCompressedTexture,Ee=S.image[0]&&S.image[0].isDataTexture,de=[];for(let ee=0;ee<6;ee++)!ue&&!Ee?de[ee]=m(S.image[ee],!0,r.maxCubemapSize):de[ee]=Ee?S.image[ee].image:S.image[ee],de[ee]=rn(S,de[ee]);const ce=de[0],Ae=s.convert(S.format,S.colorSpace),Ce=s.convert(S.type),Ie=y(S.internalFormat,Ae,Ce,S.normalized,S.colorSpace),L=S.isVideoTexture!==!0,oe=re.__version===void 0||V===!0,Q=q.dataReady;let fe=E(S,ce);Ve(t.TEXTURE_CUBE_MAP,S);let ge;if(ue){L&&oe&&n.texStorage2D(t.TEXTURE_CUBE_MAP,fe,Ie,ce.width,ce.height);for(let ee=0;ee<6;ee++){ge=de[ee].mipmaps;for(let Me=0;Me<ge.length;Me++){const Se=ge[Me];S.format!==Hn?Ae!==null?L?Q&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Me,0,0,Se.width,Se.height,Ae,Se.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Me,Ie,Se.width,Se.height,0,Se.data):be("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?Q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Me,0,0,Se.width,Se.height,Ae,Ce,Se.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Me,Ie,Se.width,Se.height,0,Ae,Ce,Se.data)}}}else{if(ge=S.mipmaps,L&&oe){ge.length>0&&fe++;const ee=je(de[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,fe,Ie,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(Ee){L?Q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,de[ee].width,de[ee].height,Ae,Ce,de[ee].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Ie,de[ee].width,de[ee].height,0,Ae,Ce,de[ee].data);for(let Me=0;Me<ge.length;Me++){const gt=ge[Me].image[ee].image;L?Q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Me+1,0,0,gt.width,gt.height,Ae,Ce,gt.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Me+1,Ie,gt.width,gt.height,0,Ae,Ce,gt.data)}}else{L?Q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Ae,Ce,de[ee]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Ie,Ae,Ce,de[ee]);for(let Me=0;Me<ge.length;Me++){const Se=ge[Me];L?Q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Me+1,0,0,Ae,Ce,Se.image[ee]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Me+1,Ie,Ae,Ce,Se.image[ee])}}}f(S)&&_(t.TEXTURE_CUBE_MAP),re.__version=q.version,S.onUpdate&&S.onUpdate(S)}C.__version=S.version}function Re(C,S,F,V,q,re){const le=s.convert(F.format,F.colorSpace),$=s.convert(F.type),J=y(F.internalFormat,le,$,F.normalized,F.colorSpace),ue=i.get(S),Ee=i.get(F);if(Ee.__renderTarget=S,!ue.__hasExternalTextures){const de=Math.max(1,S.width>>re),ce=Math.max(1,S.height>>re);q===t.TEXTURE_3D||q===t.TEXTURE_2D_ARRAY?n.texImage3D(q,re,J,de,ce,S.depth,0,le,$,null):n.texImage2D(q,re,J,de,ce,0,le,$,null)}n.bindFramebuffer(t.FRAMEBUFFER,C),wt(S)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,V,q,Ee.__webglTexture,0,mt(S)):(q===t.TEXTURE_2D||q>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&q<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,V,q,Ee.__webglTexture,re),n.bindFramebuffer(t.FRAMEBUFFER,null)}function St(C,S,F){if(t.bindRenderbuffer(t.RENDERBUFFER,C),S.depthBuffer){const V=S.depthTexture,q=V&&V.isDepthTexture?V.type:null,re=w(S.stencilBuffer,q),le=S.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;wt(S)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,mt(S),re,S.width,S.height):F?t.renderbufferStorageMultisample(t.RENDERBUFFER,mt(S),re,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,re,S.width,S.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,le,t.RENDERBUFFER,C)}else{const V=S.textures;for(let q=0;q<V.length;q++){const re=V[q],le=s.convert(re.format,re.colorSpace),$=s.convert(re.type),J=y(re.internalFormat,le,$,re.normalized,re.colorSpace);wt(S)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,mt(S),J,S.width,S.height):F?t.renderbufferStorageMultisample(t.RENDERBUFFER,mt(S),J,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,J,S.width,S.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function ze(C,S,F){const V=S.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,C),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const q=i.get(S.depthTexture);if(q.__renderTarget=S,(!q.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),V){if(q.__webglInit===void 0&&(q.__webglInit=!0,S.depthTexture.addEventListener("dispose",A)),q.__webglTexture===void 0){q.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,q.__webglTexture),Ve(t.TEXTURE_CUBE_MAP,S.depthTexture);const ue=s.convert(S.depthTexture.format),Ee=s.convert(S.depthTexture.type);let de;S.depthTexture.format===Li?de=t.DEPTH_COMPONENT24:S.depthTexture.format===Rr&&(de=t.DEPTH24_STENCIL8);for(let ce=0;ce<6;ce++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,de,S.width,S.height,0,ue,Ee,null)}}else N(S.depthTexture,0);const re=q.__webglTexture,le=mt(S),$=V?t.TEXTURE_CUBE_MAP_POSITIVE_X+F:t.TEXTURE_2D,J=S.depthTexture.format===Rr?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(S.depthTexture.format===Li)wt(S)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,J,$,re,0,le):t.framebufferTexture2D(t.FRAMEBUFFER,J,$,re,0);else if(S.depthTexture.format===Rr)wt(S)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,J,$,re,0,le):t.framebufferTexture2D(t.FRAMEBUFFER,J,$,re,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function it(C){const S=i.get(C),F=C.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==C.depthTexture){const V=C.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),V){const q=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,V.removeEventListener("dispose",q)};V.addEventListener("dispose",q),S.__depthDisposeCallback=q}S.__boundDepthTexture=V}if(C.depthTexture&&!S.__autoAllocateDepthBuffer)if(F)for(let V=0;V<6;V++)ze(S.__webglFramebuffer[V],C,V);else{const V=C.texture.mipmaps;V&&V.length>0?ze(S.__webglFramebuffer[0],C,0):ze(S.__webglFramebuffer,C,0)}else if(F){S.__webglDepthbuffer=[];for(let V=0;V<6;V++)if(n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[V]),S.__webglDepthbuffer[V]===void 0)S.__webglDepthbuffer[V]=t.createRenderbuffer(),St(S.__webglDepthbuffer[V],C,!1);else{const q=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,re=S.__webglDepthbuffer[V];t.bindRenderbuffer(t.RENDERBUFFER,re),t.framebufferRenderbuffer(t.FRAMEBUFFER,q,t.RENDERBUFFER,re)}}else{const V=C.texture.mipmaps;if(V&&V.length>0?n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=t.createRenderbuffer(),St(S.__webglDepthbuffer,C,!1);else{const q=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,re=S.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,re),t.framebufferRenderbuffer(t.FRAMEBUFFER,q,t.RENDERBUFFER,re)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function Ze(C,S,F){const V=i.get(C);S!==void 0&&Re(V.__webglFramebuffer,C,C.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),F!==void 0&&it(C)}function We(C){const S=C.texture,F=i.get(C),V=i.get(S);C.addEventListener("dispose",v);const q=C.textures,re=C.isWebGLCubeRenderTarget===!0,le=q.length>1;if(le||(V.__webglTexture===void 0&&(V.__webglTexture=t.createTexture()),V.__version=S.version,a.memory.textures++),re){F.__webglFramebuffer=[];for(let $=0;$<6;$++)if(S.mipmaps&&S.mipmaps.length>0){F.__webglFramebuffer[$]=[];for(let J=0;J<S.mipmaps.length;J++)F.__webglFramebuffer[$][J]=t.createFramebuffer()}else F.__webglFramebuffer[$]=t.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){F.__webglFramebuffer=[];for(let $=0;$<S.mipmaps.length;$++)F.__webglFramebuffer[$]=t.createFramebuffer()}else F.__webglFramebuffer=t.createFramebuffer();if(le)for(let $=0,J=q.length;$<J;$++){const ue=i.get(q[$]);ue.__webglTexture===void 0&&(ue.__webglTexture=t.createTexture(),a.memory.textures++)}if(C.samples>0&&wt(C)===!1){F.__webglMultisampledFramebuffer=t.createFramebuffer(),F.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let $=0;$<q.length;$++){const J=q[$];F.__webglColorRenderbuffer[$]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,F.__webglColorRenderbuffer[$]);const ue=s.convert(J.format,J.colorSpace),Ee=s.convert(J.type),de=y(J.internalFormat,ue,Ee,J.normalized,J.colorSpace,C.isXRRenderTarget===!0),ce=mt(C);t.renderbufferStorageMultisample(t.RENDERBUFFER,ce,de,C.width,C.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+$,t.RENDERBUFFER,F.__webglColorRenderbuffer[$])}t.bindRenderbuffer(t.RENDERBUFFER,null),C.depthBuffer&&(F.__webglDepthRenderbuffer=t.createRenderbuffer(),St(F.__webglDepthRenderbuffer,C,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(re){n.bindTexture(t.TEXTURE_CUBE_MAP,V.__webglTexture),Ve(t.TEXTURE_CUBE_MAP,S);for(let $=0;$<6;$++)if(S.mipmaps&&S.mipmaps.length>0)for(let J=0;J<S.mipmaps.length;J++)Re(F.__webglFramebuffer[$][J],C,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+$,J);else Re(F.__webglFramebuffer[$],C,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+$,0);f(S)&&_(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(le){for(let $=0,J=q.length;$<J;$++){const ue=q[$],Ee=i.get(ue);let de=t.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(de=C.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(de,Ee.__webglTexture),Ve(de,ue),Re(F.__webglFramebuffer,C,ue,t.COLOR_ATTACHMENT0+$,de,0),f(ue)&&_(de)}n.unbindTexture()}else{let $=t.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&($=C.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture($,V.__webglTexture),Ve($,S),S.mipmaps&&S.mipmaps.length>0)for(let J=0;J<S.mipmaps.length;J++)Re(F.__webglFramebuffer[J],C,S,t.COLOR_ATTACHMENT0,$,J);else Re(F.__webglFramebuffer,C,S,t.COLOR_ATTACHMENT0,$,0);f(S)&&_($),n.unbindTexture()}C.depthBuffer&&it(C)}function Tt(C){const S=C.textures;for(let F=0,V=S.length;F<V;F++){const q=S[F];if(f(q)){const re=M(C),le=i.get(q).__webglTexture;n.bindTexture(re,le),_(re),n.unbindTexture()}}}const bt=[],Nt=[];function Bt(C){if(C.samples>0){if(wt(C)===!1){const S=C.textures,F=C.width,V=C.height;let q=t.COLOR_BUFFER_BIT;const re=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,le=i.get(C),$=S.length>1;if($)for(let ue=0;ue<S.length;ue++)n.bindFramebuffer(t.FRAMEBUFFER,le.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ue,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,le.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ue,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,le.__webglMultisampledFramebuffer);const J=C.texture.mipmaps;J&&J.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,le.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,le.__webglFramebuffer);for(let ue=0;ue<S.length;ue++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(q|=t.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(q|=t.STENCIL_BUFFER_BIT)),$){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,le.__webglColorRenderbuffer[ue]);const Ee=i.get(S[ue]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Ee,0)}t.blitFramebuffer(0,0,F,V,0,0,F,V,q,t.NEAREST),l===!0&&(bt.length=0,Nt.length=0,bt.push(t.COLOR_ATTACHMENT0+ue),C.depthBuffer&&C.resolveDepthBuffer===!1&&(bt.push(re),Nt.push(re),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,Nt)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,bt))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),$)for(let ue=0;ue<S.length;ue++){n.bindFramebuffer(t.FRAMEBUFFER,le.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ue,t.RENDERBUFFER,le.__webglColorRenderbuffer[ue]);const Ee=i.get(S[ue]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,le.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ue,t.TEXTURE_2D,Ee,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,le.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const S=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[S])}}}function mt(C){return Math.min(r.maxSamples,C.samples)}function wt(C){const S=i.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function I(C){const S=a.render.frame;d.get(C)!==S&&(d.set(C,S),C.update())}function rn(C,S){const F=C.colorSpace,V=C.format,q=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||F!==Pl&&F!==$i&&(He.getTransfer(F)===et?(V!==Hn||q!==Rn)&&be("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ye("WebGLTextures: Unsupported texture color space:",F)),S}function je(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(u.width=C.naturalWidth||C.width,u.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(u.width=C.displayWidth,u.height=C.displayHeight):(u.width=C.width,u.height=C.height),u}this.allocateTextureUnit=K,this.resetTextureUnits=X,this.getTextureUnits=G,this.setTextureUnits=O,this.setTexture2D=N,this.setTexture2DArray=Y,this.setTexture3D=j,this.setTextureCube=te,this.rebindTextures=Ze,this.setupRenderTarget=We,this.updateRenderTargetMipmap=Tt,this.updateMultisampleRenderTarget=Bt,this.setupDepthRenderbuffer=it,this.setupFrameBufferTexture=Re,this.useMultisampledRTT=wt,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function nR(t,e){function n(i,r=$i){let s;const a=He.getTransfer(r);if(i===Rn)return t.UNSIGNED_BYTE;if(i===Zd)return t.UNSIGNED_SHORT_4_4_4_4;if(i===Qd)return t.UNSIGNED_SHORT_5_5_5_1;if(i===g_)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===__)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===p_)return t.BYTE;if(i===m_)return t.SHORT;if(i===Ba)return t.UNSIGNED_SHORT;if(i===Kd)return t.INT;if(i===ui)return t.UNSIGNED_INT;if(i===ni)return t.FLOAT;if(i===Pi)return t.HALF_FLOAT;if(i===v_)return t.ALPHA;if(i===x_)return t.RGB;if(i===Hn)return t.RGBA;if(i===Li)return t.DEPTH_COMPONENT;if(i===Rr)return t.DEPTH_STENCIL;if(i===S_)return t.RED;if(i===Jd)return t.RED_INTEGER;if(i===Fr)return t.RG;if(i===jd)return t.RG_INTEGER;if(i===eh)return t.RGBA_INTEGER;if(i===Jo||i===jo||i===el||i===tl)if(a===et)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Jo)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===jo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===el)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===tl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Jo)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===jo)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===el)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===tl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Sf||i===yf||i===Mf||i===Ef)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Sf)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===yf)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Mf)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Ef)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Tf||i===wf||i===Af||i===Rf||i===Cf||i===Cl||i===bf)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Tf||i===wf)return a===et?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Af)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Rf)return s.COMPRESSED_R11_EAC;if(i===Cf)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Cl)return s.COMPRESSED_RG11_EAC;if(i===bf)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Pf||i===Lf||i===Df||i===If||i===Nf||i===Uf||i===Ff||i===Of||i===Bf||i===zf||i===kf||i===Vf||i===Hf||i===Gf)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Pf)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Lf)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Df)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===If)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Nf)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Uf)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Ff)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Of)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Bf)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===zf)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===kf)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Vf)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Hf)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Gf)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Wf||i===Xf||i===Yf)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Wf)return a===et?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Xf)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Yf)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===qf||i===$f||i===bl||i===Kf)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===qf)return s.COMPRESSED_RED_RGTC1_EXT;if(i===$f)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===bl)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Kf)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===za?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const iR=`
void main() {
...
}`;function mR({variation:t=0,pixelRatioProp:e,shapeSize:n=1,roundness:i=0,borderSize:r=.5,circleSize:s=.5,circleEdge:a=.5,color:o="#c9a84c",className:l="",style:u}){const d=ke.useRef(null);return ke.useEffect(()=>{const h=d.current;if(!h)return;const c=h.clientWidth,p=h.clientHeight,g=new dR({antialias:!0,alpha:!0});g.setPixelRatio(e||Math.min(window.devicePixelRatio,2)),g.setSize(c,p),h.appendChild(g.domElement);const x=new KM,m=new sh(-1,1,1,-1,0,1),f={u_time:{value:0},u_mouse:{value:new $e(.5,.5)},u_pixelRatio:{value:g.getPixelRatio()},u_resolution:{value:new $e(c,p)},u_color:{value:new Qe(o)},u_shapeSize:{value:n},u_roundness:{value:i},u_borderSize:{value:r},u_circleSize:{value:s},u_circleEdge:{value:a}},_=new Yn({vertexShader:hR,fragmentShader:pR,uniforms:f,defines:{VAR:t},transparent:!0,blending:lf,depthTest:!1}),M=new $a(2,2),y=new ci(M,_);x.add(y);const w=b=>{const P=h.getBoundingClientRect(),D=(b.clientX-P.left)/P.width,X=1-(b.clientY-P.top)/P.height;f.u_mouse.value.set(D,X)},E=()=>{const b=h.clientWidth,P=h.clientHeight;g.setSize(b,P),f.u_resolution.value.set(b,P)};window.addEventListener("mousemove",w),window.addEventListener("resize",E);const A=new g1;let v;const R=()=>{f.u_time.value=A.getElapsedTime(),g.render(x,m),v=requestAnimationFrame(R)};return R(),()=>{window.removeEventListener("mousemove",w),window.removeEventListener("resize",E),cancelAnimationFrame(v),g.dispose(),M.dispose(),_.dispose(),g.domElement.parentNode&&g.domElement.parentNode.removeChild(g.domElement)}},[t,e,n,i,r,s,a,o]),Ke.jsx("div",{ref:d,className:l,style:{width:"100%",height:"100%",pointerEvents:"none",...u}})}const ra="cubic-bezier(0.4,0,0.2,1)",_r=650,gR={center:{left:50,scale:1,op:1,blur:0,rot:0,z:50},right:{left:72,scale:.62,op:.6,blur:1.5,rot:-26,z:40},left:{left:28,scale:.62,op:.6,blur:1.5,rot:26,z:40},backRight:{left:87,scale:.42,op:.3,blur:3,rot:-34,z:30},backLeft:{left:13,scale:.42,op:.3,blur:3,rot:34,z:30},deepBack:{left:50,scale:.3,op:.12,blur:5,rot:0,z:20}};function _R(t,e,n){const i=(t-e+n)%n;return i===0?"center":i===1?"right":i===n-1?"left":i===2?"backRight":i===n-2?"backLeft":"deepBack"}function vR(t,e,n,i){const r=gR[t],s=n?50+(r.left-50)*.62:r.left,a=n?r.scale*.82:r.scale;return{transform:`translate(-50%, -50%) translateX(${(s-50).toFixed(3)}vw) scale(${a}) rotateY(${r.rot}deg)`,opacity:r.op,filter:`blur(${r.blur}px)`,zIndex:r.z,boxShadow:t==="center"?`0 0 70px ${e.glow}66, 0 30px 70px rgba(0,0,0,.55)`:"0 20px 50px rgba(0,0,0,.45)",pointerEvents:i?"none":"auto"}}function xR(){const t=Zs.length,[e,n]=ke.useState(0),[i,r]=ke.useState(!1),[s,a]=ke.useState(typeof window<"u"?window.innerWidth<640:!1),[o,l]=ke.useState(!1),u=ke.useRef(!1);ke.useRef(0);const d=ke.useRef(!1),h=Zs[e];ke.useEffect(()=>{Zs.forEach(x=>{const m=new Image;m.src=x.preview})},[]),ke.useEffect(()=>{const x=()=>a(window.innerWidth<640);return window.addEventListener("resize",x),()=>window.removeEventListener("resize",x)},[]);const c=ke.useCallback(x=>{d.current||(d.current=!0,r(!0),n(m=>x===1?(m+1)%t:(m+t-1)%t),window.setTimeout(()=>{d.current=!1,r(!1)},_r))},[t]),p=ke.useCallback(x=>{d.current||x===e||(d.current=!0,r(!0),n(x),window.setTimeout(()=>{d.current=!1,r(!1)},_r))},[e]);ke.useEffect(()=>{u.current=o},[o]),ke.useEffect(()=>{const x=window.setInterval(()=>{u.current||d.current||c(1)},3e3);return()=>window.clearInterval(x)},[c]),ke.useEffect(()=>{const x=()=>l(document.hidden);return document.addEventListener("visibilitychange",x),()=>document.removeEventListener("visibilitychange",x)},[]),ke.useEffect(()=>{const x=m=>{m.key==="ArrowLeft"?c(-1):m.key==="ArrowRight"&&c(1)};return window.addEventListener("keydown",x),()=>window.removeEventListener("keydown",x)},[c]);const g=`transform ${_r}ms ${ra}, opacity ${_r}ms ${ra}, filter ${_r}ms ${ra}`;return Ke.jsxs("div",{className:"pg-root",style:{background:h.bg,transition:`background ${_r}ms ${ra}`},onMouseEnter:()=>l(!0),onMouseLeave:()=>l(!1),children:[Ke.jsx("div",{className:"pg-rays","aria-hidden":!0,children:Ke.jsx(Jy,{speed:2.5,rayColor1:"#EAB308",rayColor2:"#96c8ff",intensity:1.25,spread:2.4,origin:"top-right",tilt:8,saturation:1.35,blend:.74,falloff:1.6,opacity:.5})}),Ke.jsx("div",{className:"pg-shapeblur","aria-hidden":!0,children:Ke.jsx(mR,{variation:2,shapeSize:1.25,roundness:.45,borderSize:.55,circleSize:.7,circleEdge:.7,color:"#d8b25a"})}),Ke.jsxs("nav",{className:"pg-nav",children:[Ke.jsx("a",{className:"pg-brand",href:"./",children:"敦 煌 纹 样"}),Ke.jsxs("div",{className:"pg-nav-links",children:[Ke.jsx("a",{className:"pg-nav-link",href:"./",children:"首页"}),Ke.jsx("span",{className:"pg-nav-link is-active",children:"纹样轮播"})]})]}),Zs.map((x,m)=>Ke.jsx("div",{className:"pg-watermark","aria-hidden":!0,style:{opacity:m===e?.09:0,color:x.glow,transition:`opacity ${_r}ms ${ra}`},children:x.en},x.id)),Zs.map((x,m)=>{const f=_R(m,e,t),_=vR(f,x,s,i),M=f==="center";return Ke.jsx("a",{href:x.route,className:"pg-card","aria-current":M,style:{..._,transition:g,cursor:"pointer"},onClick:y=>{if(d.current){y.preventDefault();return}M||(y.preventDefault(),p(m))},children:Ke.jsx("img",{src:x.preview,alt:x.name,className:"pg-img",draggable:!1,style:{filter:x.preview.endsWith(".svg")?`drop-shadow(0 0 3px rgba(0,0,0,.9)) invert(1) brightness(1.12) drop-shadow(0 0 16px ${x.glow})`:`drop-shadow(0 0 3px rgba(0,0,0,.9)) drop-shadow(0 0 16px ${x.glow})`}})},x.id)}),Ke.jsx("div",{className:"pg-noise","aria-hidden":!0}),Ke.jsxs("div",{className:"pg-info",children:[Ke.jsx("h1",{className:"pg-info-title",style:{textShadow:`0 0 55px ${h.glow}45`},children:h.name}),Ke.jsxs("div",{className:"pg-info-subtitle",children:[h.sub,Ke.jsx("span",{style:{color:h.glow},children:h.en})]}),Ke.jsx("p",{className:"pg-info-desc",children:h.desc}),Ke.jsxs("div",{className:"pg-arrows",children:[Ke.jsx("button",{className:"pg-arrow","aria-label":"上一个纹样",onClick:()=>c(-1),disabled:i,children:Ke.jsx(AS,{size:22})}),Ke.jsx("button",{className:"pg-arrow","aria-label":"下一个纹样",onClick:()=>c(1),disabled:i,children:Ke.jsx(RS,{size:22})})]})]},e),Ke.jsxs("a",{className:"pg-guide",href:h.route,onClick:x=>{d.current&&x.preventDefault()},children:[Ke.jsx("span",{children:"点击选中 · 再次点击进入详情"}),Ke.jsx(wS,{size:20})]})]})}function SR(){return Ke.jsx(xR,{})}dc.createRoot(document.getElementById("root")).render(Ke.jsx(cv.StrictMode,{children:Ke.jsx(SR,{})}));
